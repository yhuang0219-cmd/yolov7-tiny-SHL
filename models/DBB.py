...
def conv_bn_dbb(in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, groups=1,
            padding_mode='zeros'):
...
class DiverseBranchBlock(nn.Module):
    def __init__(self, in_channels, out_channels, k,
        ...
        if deploy:
            ...
            self.dbb_origin = conv_bn_dbb(in_channels=in_channels, out_channels=out_channels, kernel_size=k, stride=s,
                                      padding=p, groups=g)
            ...
            if g < out_channels:
                ...
                self.dbb_1x1 = conv_bn_dbb(in_channels=in_channels, out_channels=out_channels, kernel_size=1, stride=s,
                                       padding=0, groups=g)
            else:
