...
class yolov7_tiny_E_ELAN_ODC(nn.Module):
    def __init__(self, inc, ouc, hidc, act=True):
        super(yolov7_tiny_E_ELAN_ODC, self).__init__()

        self.conv1 = Conv(inc, hidc, k=1, act=act)
        self.conv2 = Conv(inc, hidc, k=1, act=act)
        self.conv3 = ODConv2d(hidc, hidc, k=3, act=act)
        self.conv4 = ODConv2d(hidc, hidc, k=3, act=act)
